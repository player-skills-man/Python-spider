# YYL->READCODE-> 8
# 爬虫启动(调度)，scheduler. 将spider 加入queue
...
class SpiderScheduler(object):
    ...
    def schedule(self, project, spider_name, priority=0.0, **spider_args):
        ...
        # priority 优先级 passed as kw for compat w/ custom queue. TODO use pos in 1.4
    ...
    def update_projects(self):
        ...
        # self.queues -> <scrapyd.spiderqueue.SqliteSpiderQueue...>
