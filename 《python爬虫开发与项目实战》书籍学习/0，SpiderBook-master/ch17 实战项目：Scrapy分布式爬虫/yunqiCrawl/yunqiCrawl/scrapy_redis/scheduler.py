...
QUEUE_KEY = '%(spider-re)s:requests'
QUEUE_CLASS = 'scrapy_redis.queue.SpiderPriorityQueue'
DUPEFILTER_KEY = '%(spider-re)s:dupefilter'
IDLE_BEFORE_CLOSE = 0
...
class Scheduler(object):
    ...
    def open(self, spider):
        ...
        self.df = RFPDupeFilter(self.server_filter, self.dupefilter_key % {'spider-re': (self.queue_name if self.queue_name else spider.name)})
